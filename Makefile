...
deploy-test dt:
	...
	@gcloud functions deploy TestdeviceControlApi --set-env-vars cloudRegion=$(cloudRegion) --set-env-vars PROJECT_ID=$(PROJECT_ID) --set-env-vars registryId=$(registryId) --runtime nodejs8 --trigger-http --entry-point deviceControlApi
